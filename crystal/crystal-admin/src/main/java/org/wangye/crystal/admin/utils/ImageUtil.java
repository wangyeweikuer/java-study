package org.wangye.crystal.admin.utils;
//package org.wangye.crystal.admin.utils;
//
...
//	public static void reduceImg(InputStream src, OutputStream dist, int maxWidth, int maxHeight) throws IOException {
...
//	 * @throws Exception
//	 */
//	public static void transform(InputStream src, OutputStream dist, ImgType type) throws Exception {
//		RenderedImage img = ImageIO.read(src);
//		ImageIO.write(img, type.name(), dist);
//	}
//
